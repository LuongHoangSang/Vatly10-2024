...
\hideall{
$$S=\xsi{\left(209\pm4\right)}{\centi\meter^2}.$$
...
\hideall{
$$R=\xsi{\left(7,7\pm1,4\right)}{\ohm}.$$
}
...
\hideall{
Sai số tuyệt đối: $\Delta m=\SI{0.2}{\kilogram}$.\\
Sai số tương đối: $\delta m=\SI{4.65}{\percent}$.\\
...
\begin{enumerate}[label=\alph*)]
	...
	\item $\delta v=\SI{2.41}{\percent}$; $\Delta v=\SI{0.0053}{\meter/\second}$.\\
	Kết quả tính: $v=\xsi{0,2225\pm0,0053}{\meter/\second}$.
\end{enumerate}
}
