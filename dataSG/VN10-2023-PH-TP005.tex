...
\viduii{3}{Lúc 7 giờ, một người ở A chuyển động thẳng đều với $ v_A= \SI{36}{km/h}$ đuổi theo người ở B đang chuyển động với $v_B = \SI{5}{m/s}$. Biết $AB = \SI{18}{km}$. Viết phương trình chuyển động của 2 người. Hai người đuổi kịp nhau tại nơi cách A một khoảng 
	\begin{mcq}(4)
		\item $\SI{58}{km}$.
		\item $\SI{46}{km}$.
		\item $\SI{36}{km}$.
