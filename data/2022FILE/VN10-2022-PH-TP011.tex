...
\begin{enumerate}[label=\bfseries Câu \arabic*:]
	...
	{Nêu cách phân biệt chuyển động thẳng nhanh dần đều và chuyển động thẳng chậm dần đều một cách định tính và định lượng.}
	\hideall{
	...
	\hideall{
		...
		\Rightarrow t=\SI{4,14}{s}\ (\text{nhận}); t = -\SI{24}{s}\ (\text{loại}).$$
		
		Vận tốc của xe:
		
		$$v = v_0 + at \Rightarrow v = \SI{28,28}{m/s}.$$
	...
	\hideall{
		...
		\begin{enumerate}[label=\alph*)]
			...
			\item Thời gian hãm phanh
			
			$$a = \dfrac{v - v_0}{t} \Rightarrow t = \dfrac{v - v_0}{a} = \SI{3,5}{s}.$$
		\end{enumerate}
	}
	\item \mkstar{3}
	...
	{
		Một đoàn tàu đang chuyển động với $v_0 = \SI{72}{km/h}$ thì hãm phanh chuyển động chậm dần đều, sau 10 giây đạt $v_1 = \SI{54}{km/h}$.
		\begin{enumerate}[label=\alph*)]
			\item Sau bao lâu kể từ lúc hãm phanh thì tàu đạt $v = \SI{36}{km/h}$ và sau bao lâu thì dừng hẳn?
			\item Tính quãng đường đoàn tàu đi được cho đến lúc dừng lại.
		\end{enumerate}
	}
	...
	\hideall{
		...
		\begin{enumerate}[label=\alph*)]
			\item Gia tốc của tàu
			
			$$a = \dfrac{v_1 - v_0}{\Delta t} = - \SI{0,5}{m/s}^2.$$
		
			Thời gian kể từ lúc hãm phanh đến khi tàu đạt vận tốc $v = \SI{36}{km/h}$ 
			
			$$ v = v_0 + at \Rightarrow t = \dfrac{v - v_0}{a} = \SI{20}{s}.$$
		
			Khi dừng hẳn $v_2 = 0$
			
			$$v_2 = v_0 + at_2 \Rightarrow t_2 = \SI{40}{s}.$$
			
			
			\item Quãng đường đoàn tàu đi được cho đến lúc dừng lại
			
			$$v^2_2 - v_0^2 =2as \Rightarrow s = \SI{400}{m}.$$
		\end{enumerate}
	}
	\item \mkstar{3}
	
	{
		...
		Một xe lửa dừng lại hẳn sau $\SI{20}{s}$ kể từ lúc bắt đầu hãm phanh. Trong thời gian đó xe chạy được $\SI{120}{m}$. Tính vận tốc của xe lúc bắt đầu hãm phanh và gia tốc của xe.
	}
	...
	\hideall{
		...
		Từ công thức 
		$$v = v_0 + at \Rightarrow v_0 = v - at = - 20a\ (1).$$
	...
	Một chiếc canô chạy với $v = \SI{16}{m/s}$, $a = \SI{2}{m/s}^2$ cho đến khi đạt được $v = \SI{24}{m/s}$ thì bắt đầu giảm tốc độ cho đến khi dừng hẳn. Biết canô từ lúc bắt đầu tăng vận tốc cho đến khi dừng hẳn là $\SI{10}{s}$. Hỏi quãng đường canô đã chạy?
	}
	...
	\hideall{
		...
		$$v = v_0 + at_1 \Rightarrow t_1 = \SI{4}{s}.$$
